...
{
    if (starts_with(p, "==") || starts_with(p, "!=") || starts_with(p, "<=") || starts_with(p, ">=") || starts_with(p, "->") || starts_with(p, "+=") || starts_with(p, "-=") || starts_with(p, "*=") || starts_with(p, "/=") || starts_with(p, "++") || starts_with(p, "--") || starts_with(p, "%=") || starts_with(p, "&=") || starts_with(p, "|=") || starts_with(p, "^=") || starts_with(p, "&&") || starts_with(p, "||"))
    {
        return 2;
    }
...
{
    return equal(tok, "return") || equal(tok, "if") || equal(tok, "else") || equal(tok, "for") || equal(tok, "while") || equal(tok, "char") || equal(tok, "int") || equal(tok, "sizeof") || equal(tok, "struct") || equal(tok, "union") || equal(tok, "short") || equal(tok, "long") || equal(tok, "void") || equal(tok, "typedef") || equal(tok, "_Bool") || equal(tok, "enum") || equal(tok, "static");
}
